...
#define _4000_SCI_CLOCK_MODE_TI0N               (0x4000U) /* clock input fSCK from the SCKp pin (slave transfer in CSI mode) */
/* Selection of start trigger source (STSmn) */
#define _0000_SCI_TRIGGER_SOFTWARE              (0x0000U) /* only software trigger is valid (selected for CSI, UART transmission, and simplified I2C) */
...
#define _0000_SCI_MODE_CSI                      (0x0000U) /* CSI mode */
...
Macro definitions
***********************************************************************************************************************/
#define _CE00_SCI0_CH0_BAUDRATE_DIVISOR         (0xCE00U) /* transfer clock set by dividing the operating clock */
#define _CE00_SCI0_CH1_BAUDRATE_DIVISOR         (0xCE00U) /* transfer clock set by dividing the operating clock */
...
#define _8800_SCI0_CH1_BAUDRATE_DIVISOR         (0x8800U) /* transfer clock set by dividing the operating clock */
